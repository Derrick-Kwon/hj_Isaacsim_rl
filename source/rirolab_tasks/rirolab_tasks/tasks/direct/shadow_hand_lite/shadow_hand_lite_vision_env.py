...
# Vision Environment for Shadow Hand Lite for in-hand manipulation tasks.
...
class ShadowHandLiteVisionEnvCfg(ShadowHandLiteEnvCfg):
    ...
    tiled_camera: TiledCameraCfg = TiledCameraCfg(
        ...
        # data_types=["rgb", "depth", "semantic_segmentation", "instance_segmentation_fast", "instance_id_segmentation_fast"],
...
@configclass
class ShadowHandLiteVisionEnvPlayCfg(ShadowHandLiteVisionEnvCfg):
    # scene
...
class ShadowHandLiteVisionEnv(InHandManipulationEnv):
    cfg: ShadowHandLiteVisionEnvCfg

    def __init__(self, cfg: ShadowHandLiteVisionEnvCfg, render_mode: str | None = None, **kwargs):
