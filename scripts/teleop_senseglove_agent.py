...
def pre_process_actions(
    ...
    hand_dof_lower_limits = None, hand_dof_upper_limits = None
) -> torch.Tensor:
...
def main():
    ...
    if args_cli.teleop_device.lower() == "keyboard":
    ...
    elif args_cli.teleop_device.lower() == "senseglove":
        ...
        teleop_interface = SenseGloveHandDevice(model_checkpoint_tag='shadowhand_lite_2025-09-11_23-57-26_data_0911_2357',
                                                model_epoch=-1)  # device handles topics/model internally
        teleop_interface.add_callback("R", reset_recording_instance)
        teleop_interface.add_callback("S", start_teleoperation)
        teleop_interface.add_callback("T", stop_teleoperation)
        ...
        raise ValueError(
            ...
            " 'handtracking', 'handtracking_abs', 'senseglove'."
        )
